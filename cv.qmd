  ...
  html:
    include-in-header: 
        - text: |
            ...
            <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.7/js/bootstrap.esm.min.js" integrity="sha512-0KgoqSj0HjRqpUysBrkciqVLvuycDwnPfuJukHZsUtCY7AURCus+rn8AX4sed7ErcSIReuKkPEFvoGr/qnY+ug==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
